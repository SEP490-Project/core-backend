...
type ProductService interface {
	...
	GetProductsPaginationV2(limit, offset int, search string, categoryID string, brandID string, userID string, productType string, productStatus string, isPreOrderOnly bool) ([]responses.ProductResponseV2, int, error)
	GetProductsPaginationV2Partial(limit, offset int, search string, categoryID string, brandID string, productType string, isPreOrderOnly bool) ([]responses.ProductResponseV2Partial, int, error)
