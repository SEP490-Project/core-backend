...
type ContractPaymentFilterRequest struct {
	...
	Status        *string `json:"status,omitempty" form:"status" validate:"omitempty,oneof=PENDING PAID OVERDUE KOL_PENDING KOL_PROOF_SUBMITTED KOL_PROOF_REJECTED KOL_REFUND_APPROVED" example:"paid"`
