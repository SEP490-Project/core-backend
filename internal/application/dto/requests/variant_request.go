...
type CreateProductVariantRequest struct {
	...
	CapacityUnit    string  `json:"capacity_unit" form:"capacity_unit" validate:"required" example:"ML"`
	ContainerType   string  `json:"container_type" form:"container_type" validate:"required" example:"BOTTLE"`
	DispenserType   string  `json:"dispenser_type" form:"dispenser_type" validate:"required" example:"SPRAY"`
...
type UpdateProductVariantRequest struct {
	...
	InputedStock    *int     `json:"input_stock" form:"input_stock" validate:"omitempty" example:"100"`
	Capacity        *float64 `json:"capacity" form:"capacity" validate:"omitempty,min=0" example:"500"`
	CapacityUnit    *string  `json:"capacity_unit" form:"capacity_unit" validate:"omitempty" example:"ML"`
	ContainerType   *string  `json:"container_type" form:"container_type" validate:"omitempty" example:"BOTTLE"`
	DispenserType   *string  `json:"dispenser_type" form:"dispenser_type" validate:"omitempty" example:"SPRAY"`
