...
type FinancialTerms struct {
	...
	PaymentDate    *any               `json:"payment_date,omitempty"` // Change this depending on PaymentCycle
	...
	ProfitDistributionDate  *any               `json:"profit_distribution_date,omitempty"` // Change this depending on ProfitDistributionCycle
}
