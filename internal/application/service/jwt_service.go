...
import (
	...
	"os"
	"core-backend/config"
	"core-backend/internal/domain/model/core"
	"time"
...
func (s *JWTService) ValidateAccessToken(tokenString string) (*core.JWTClaims, error) {
	token, err := jwt.ParseWithClaims(tokenString, &core.JWTClaims{}, func(token *jwt.Token) (any, error) {
