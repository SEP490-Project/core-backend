...
//	@Success		200	{object}	responses.APIResponse{data=responses.PaginationResponse{data=[]responses.PaymentTransactionResponse}}	"Payment transactions retrieved successfully"
//	@Failure		400	{object}	responses.APIResponse																		"Bad request"
//	@Failure		500	{object}	responses.APIResponse																		"Internal server error"
//	@Security		BearerAuth
