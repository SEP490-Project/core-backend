...
type Product struct {
	...
	AverageRating    float64            `json:"average_rating" gorm:"column:average_rating;default:0;not null"`
	...
	BrandPlaceHolder *string            `json:"brand_place_holder" gorm:"column:brand_place_holder"`
	// Relationships
