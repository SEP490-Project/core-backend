...
// EncryptToken encrypts a plaintext token using AES-256-GCM and returns base64 encoded ciphertext.
// key must be exactly 32 bytes (AES-256). If the provided key is hex-encoded, decode it before use.
